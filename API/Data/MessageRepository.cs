    ...
    public class MessageRepository : IMessageRepository
    {
        ...
        public async Task<PagedList<MessageDto>> GetMessagesForUser(MessageParams messageParams)
        {
            ...
            query = messageParams.Container switch
            {
                ...
                _ => query.Where(u => u.RecipentUsername == messageParams.Username && u.RecipentDeleted == false
                 && u.DateRead == null),
            };
        ...
        public async Task<IEnumerable<MessageDto>> GetMessageThread(string currentUserName, string recipentuserName)
        {
            var query = _context.Messages
                .Where(
                    m => m.RecipentUsername == currentUserName && m.RecipentDeleted == false &&
                    m.SenderUsername == recipentuserName ||
                    m.RecipentUsername == recipentuserName && m.SenderDeleted == false &&
